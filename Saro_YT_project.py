...
def objective():
    st.header("Objective")
    st.write("To Develop a streamlit application to scrap data from youtube and analyse the various parameters.")

def prerequisites():
    st.header("Prerequisites")
    st.write("1. Python Environment: Install Python on your system.")
    st.write("2. Google API Key: From your google cloud console to call youtube V3 Build")
    st.write("3. Dependencies: Install Streamlit, Pandas, Plotly, mysql_connector")
...
def Approach():
    ...
    st.write("Migrate data to a SQL database")
...
st.markdown("<h1 style='font-size:20px; color:red; text-align:center;'>Comprehensive Analysis of YouTube Videos and Channels Using SQL Queries</h1>", unsafe_allow_html=True)
